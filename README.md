...
But it uses [custom-react-scripts](https://github.com/kitze/custom-react-scripts), instead of its default [react-scripts](https://www.npmjs.com/package/react-scripts). 
